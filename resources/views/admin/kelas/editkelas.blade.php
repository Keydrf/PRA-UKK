                            ...
                            <div class="card-body">
                                ...
                                <form action="/updatekelas/{{$data->id_kelas}}" method="POST" class="forms-sample">
                                    ...
                                    <div class="form-group">
                                        ...
                                        <input type="text" class="form-control" id="exampleInputName1" name="nama_kelas" value="{{$data->nama_kelas}}"
                                            placeholder="Nama Kelas" />
                                    </div>
                                    <div class="form-group">
                                        <label for="exampleInputName1">Kompetensi Keahlian</label>
                                        <input type="text" class="form-control" id="exampleInputName1" name="kompetensi_keahlian" value="{{$data->kompetensi_keahlian}}"
